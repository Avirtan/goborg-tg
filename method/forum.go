...
func CloseGeneralForumTopic[ID int64 | string](ctx context.Context) (*bool, error) {
	response, err := request.RequestWithContext(ctx, request.Get, GetUrl()+"/closeGeneralForumTopic")
	if err != nil {
		return nil, err
	}
	responseJson, err := request.ResponseHandlerToType[bool](response)
...
func ReopenGeneralForumTopic[ID int64 | string](ctx context.Context) (*bool, error) {
	response, err := request.RequestWithContext(ctx, request.Get, GetUrl()+"/reopenGeneralForumTopic")
	if err != nil {
		return nil, err
	}
	responseJson, err := request.ResponseHandlerToType[bool](response)
...
func UnhideGeneralForumTopic[ID int64 | string](ctx context.Context) (*bool, error) {
	response, err := request.RequestWithContext(ctx, request.Get, GetUrl()+"/unhideGeneralForumTopic")
	if err != nil {
		return nil, err
	}
	responseJson, err := request.ResponseHandlerToType[bool](response)
